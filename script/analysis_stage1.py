...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (df
               # .Define("dummy_collection", "Mgtest::dummy_collection(TpcSegStripHits)")
               .Define("strip_x", "Mgtest::dummy_collection(TpcSegStripHits)")
               .Define("pixel_x", "Mgtest::dummy_collection(TpcSegPixelHits)")
              )
        return df2
